    ...
    return(
        ...
        <div className="d-flex flex-column">
            ...
            <div className="d-flex flex-column flex-lg-row justify-content-around mb-lg-3">
                ...
                {/* </div> */}
                <CFormFloating className=" col-lg-3 mb-3">
                    <CFormInput name='level' placeholder="" value={formData?.level} onChange={handleFromChange}/>
                    <CFormLabel className="ps-3" >پایه</CFormLabel>
                </CFormFloating>

                <CFormFloating className=" col-lg-3 mb-3">
                    <CFormInput name='group' placeholder="" value={formData?.group} onChange={handleFromChange}/>
                    <CFormLabel className="ps-3" >گروه</CFormLabel>
                </CFormFloating>
